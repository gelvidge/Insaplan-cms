-- MarketingPages global — additional tabs
-- Contact, Blog, Product Overview, Product Features, Pricing, Legal, Support, Knowledge Base, Site Metadata
-- Apply AFTER 20260414_120000.sql

SET search_path = public;

BEGIN;

-- New scalar columns on the existing marketing_pages root row
...
-- Product Overview: steps array
CREATE TABLE IF NOT EXISTS "marketing_pages_product_overview_steps" (
...
CREATE INDEX IF NOT EXISTS "marketing_pages_product_overview_steps_order_idx" ON "marketing_pages_product_overview_steps" USING btree ("_order");
CREATE INDEX IF NOT EXISTS "marketing_pages_product_overview_steps_parent_id_idx" ON "marketing_pages_product_overview_steps" USING btree ("_parent_id");

-- Product Features: features array
CREATE TABLE IF NOT EXISTS "marketing_pages_product_features_features" (
  "_order"      integer NOT NULL,
  "_parent_id"  integer NOT NULL,
  "id"          varchar PRIMARY KEY NOT NULL,
  "icon"        varchar,
...
CREATE INDEX IF NOT EXISTS "marketing_pages_product_features_features_order_idx" ON "marketing_pages_product_features_features" USING btree ("_order");
CREATE INDEX IF NOT EXISTS "marketing_pages_product_features_features_parent_id_idx" ON "marketing_pages_product_features_features" USING btree ("_parent_id");

-- Product Features: feature benefits (child of features)
CREATE TABLE IF NOT EXISTS "marketing_pages_product_features_features_benefits" (
  "_order"     integer NOT NULL,
...
CREATE INDEX IF NOT EXISTS "marketing_pages_product_features_features_benefits_order_idx" ON "marketing_pages_product_features_features_benefits" USING btree ("_order");
CREATE INDEX IF NOT EXISTS "marketing_pages_product_features_features_benefits_parent_id_idx" ON "marketing_pages_product_features_features_benefits" USING btree ("_parent_id");

-- Product Features: problems array
CREATE TABLE IF NOT EXISTS "marketing_pages_product_features_problems" (
  "_order"      integer NOT NULL,
  "_parent_id"  integer NOT NULL,
  "id"          varchar PRIMARY KEY NOT NULL,
  "problem"     varchar,
...
CREATE INDEX IF NOT EXISTS "marketing_pages_product_features_problems_order_idx" ON "marketing_pages_product_features_problems" USING btree ("_order");
CREATE INDEX IF NOT EXISTS "marketing_pages_product_features_problems_parent_id_idx" ON "marketing_pages_product_features_problems" USING btree ("_parent_id");
